...
exports.CheckIfVideoAssociatedWithUser = exports.deleteRecording = exports.getRecordings = exports.AddRecordingToDB = exports.getCurrentRecordingSequence = exports.AddUserToDB = exports.verifyAndRetrieveUserEmail = void 0;
...
const deleteRecording = (BucketKey, Id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let deleteFromS3 = s3.deleteObject({
            ...
            if (err) {
                ...
                try {
                    let deletevid = yield prisma_1.default.recordings.delete({
                        where: {
                            Id: Id
                        }
                    });
...
const CheckIfVideoAssociatedWithUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const accessToken = (_a = req.cookies) === null || _a === void 0 ? void 0 : _a.talkscribe_accessToken;
        let { Id, PublicUrl } = req.body;
        console.log(req.body);
        (0, exports.verifyAndRetrieveUserEmail)(accessToken).then((_a) => __awaiter(void 0, [_a], void 0, function* ({ UserEmail, UserName }) {
            let transaction = yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                let recording = yield tx.recordings.findUnique({
                    where: {
                        Id: Id,
                        User: User
                    }
...
exports.CheckIfVideoAssociatedWithUser = CheckIfVideoAssociatedWithUser;
